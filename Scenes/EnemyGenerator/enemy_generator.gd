...
var currently_alive:Array[BaseActor] = []
...
@export var enemy_model:Resource
## Number of enemies in each of the waves. Provisional, will get more complex.
@export var sequences:Array[int] = []
@export_group("Debug")
@export var verbose:bool = false

## Method to be called on the enemy_model to create one of them
var actor_maker:Callable = func(m): m.make_one()
...
func generate()-> void:
	var new_enemy:BaseActor = actor_maker.call(enemy_model)
