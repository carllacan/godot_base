...
## Value against which the quantity will be compared the first time. Leave
## to the default NAN value to skip the first comparison.
@export var initial_value:float = NAN
